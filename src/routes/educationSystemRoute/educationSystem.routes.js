...
import { addAgreement, addDecree, addLanguage, addSchool, addStage, createStateSystem, createTypeOfHeis, editDecree, editSchool, getAgreementByStateID, getAllStateSystems, getEducationSystemByStateID, removeAgreement, removeDecree, removeLanguage, removeSchool, removeStage, removeTypeOfHeis, updateStage, updateStateSystem, updatetypeOfHeis } from "../../controllers/educationSystemController/educationSystem.controller.js";
import { authorize, protect } from "../../middlewares/auth.middleware.js";
import { checkStateResponsibility } from "../../middlewares/responsibility.middleware.js";
import { agreementSchama, languageSchama, preHeis, stageSchema, stateSystemSchema, typeOfHeis, updateDecreeSchema, updateStateSystemSchema, validate } from "../../validations/educationSystem.validation.js";
